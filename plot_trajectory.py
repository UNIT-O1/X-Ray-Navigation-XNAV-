...
# Initialize the "previous position" guess with the first true position.
previous_true_pos_km = true_positions[0] 
...
for r_sc_true_km in tqdm(true_positions, desc="Navigating"):
    ...
    # 2. Use the previous step's true position as the initial guess.
    initial_guess_millions_km = previous_true_pos_km / 1e6

    # 3. Solve for the current position
    ...
    # 4. Update the "previous" position for the next loop.
    previous_true_pos_km = r_sc_true_km
